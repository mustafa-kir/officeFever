...
public class workDesk : MonoBehaviour
{
    ...
    private IEnumerator MakeMoney()
    {
        ...
        while (counter < transform.childCount)
        {
            ...
            GameObject NewDollar = Instantiate(Dollar, new Vector3(DollarPlace.GetChild(DollarPlaceIndex).position.x, YAxis, DollarPlace.GetChild(DollarPlaceIndex).position.z),
